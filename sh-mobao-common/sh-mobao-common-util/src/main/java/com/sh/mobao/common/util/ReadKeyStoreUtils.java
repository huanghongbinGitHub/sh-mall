...
//		/Users/xiaohuang/sh/cer/mobao-alias.keystore
		String keyStorePath = "/Users/xiaohuang/sh/cer/mobao-alias.keystore";


		String strPublicKey = getStrPublicKey(keyStorePath, "mobao-alias", "123456");
		System.out.println("公钥："+strPublicKey);

		String strPrivateKey = getStrPrivateKey(keyStorePath, "mobao-alias", "123456", "123456");
